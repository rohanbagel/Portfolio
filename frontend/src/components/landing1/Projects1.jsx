        ...
        <div className="space-y-8">
          {projects.map((project, index) => (
            <motion.div
              ...
              className="group"
            >
              <div className={`border-4 p-5 sm:p-6 md:p-8 lg:p-10 md:pb-24 transition-all duration-500 relative overflow-hidden ${
                isDark
                ...
                <div className="flex flex-col lg:flex-row lg:items-start lg:justify-between gap-6">
                  ...
                  <div className="flex-shrink-0">
                    <span className="font-['Bebas_Neue'] text-5xl sm:text-6xl md:text-8xl text-red-500 group-hover:text-red-600">
                      0{index + 1}
                    </span>
                  </div>
                  ...
                  <div className="flex-1 flex flex-col">
                    <h3 className="font-['Bebas_Neue'] text-3xl sm:text-4xl md:text-5xl mb-4">
                      {project.title}
                    </h3>
                    <p className="font-['Space_Mono'] text-xs sm:text-sm md:text-base mb-5 md:mb-6 leading-relaxed opacity-80">
                      {project.description}
                    </p>
                    ...
                    <div className="flex flex-wrap gap-2 mb-6">
                      {project.tech.map((tech) => (
                        <span
                          key={tech}
                          className="font-['Space_Mono'] text-[11px] sm:text-xs px-2.5 sm:px-3 py-1 border border-current"
                        >
                          {tech}
                        </span>
                      ))}
                    ...
                    <ul className="space-y-2 mb-6">
                      {project.highlights.map((highlight) => (
                        <li
                          key={highlight}
                          className="font-['Space_Mono'] text-xs sm:text-sm flex items-center gap-3"
                        >
                ...
                <div className="mt-6 flex flex-col gap-3 items-start sm:flex-row sm:items-center sm:gap-4 md:absolute md:right-6 md:bottom-6 md:flex-col md:items-end z-10">
                  {project.links?.live ? (
                    <motion.a
